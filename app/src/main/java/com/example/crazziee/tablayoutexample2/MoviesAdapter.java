...
/**
 * Created by Crazziee on 12/18/2017.
 */
...
public class MoviesAdapter extends RecyclerView.Adapter<MoviesAdapter.MovieViewHolder> {
    ...
    public static String IMAGE_URL_BASE_PATH="http://image.tmdb.org/t/p/w342//";
        ...
        public MovieViewHolder(View v) {
            ...
            moviesLayout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("overview",movieDescription.getText().toString());
                    intent.putExtra("rating",rating.getText().toString());
                    intent.putExtra("date",data.getText().toString());
                    intent.putExtra("image",IMAGE_URL_BASE_PATH +movies.get(position).getPosterPath());
